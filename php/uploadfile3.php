...
$patch="http://127.0.0.1/weixinfc/upload/files/";//程序所在路径   
   ...
   //生成目标文件的文件名       
    ...
    $filename=explode(".",$_FILES['picture']['name']);   
 	  ...
 	  while(file_exists($uploadfile));   
		...
		$uploadfile="../../building/".$loupanid."/img/hx/".$ImgName;
   		...
   		if(is_uploaded_file($_FILES['picture']['tmp_name']))
   		{
   			if (move_uploaded_file($_FILES['picture']['tmp_name'],$uploadfile))
   			{
   				...
   				//echo "$Callback($Result)";
   				 ...
   				 $uploadfile=substr($uploadfile, 5);
   				 
   				 $uploadfile="http://112.124.55.78/" . $uploadfile;
   				 
   				 //$uploadfile="http://localhost/weixinfc/admin/" . $uploadfile;
